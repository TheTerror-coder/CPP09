...
/*   Updated: 2024/02/27 19:59:16 by TheTerror        ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */

#include "Libftpp.hpp"

std::string&		Libftpp::trimStartSpaces(std::string& str)
{
...
std::string&		Libftpp::trimEndSpaces(std::string& str)
{
	while (!str.empty() && std::isspace(str.at(str.size() - 1)))
	{
...
std::string&		Libftpp::trimSpaces(std::string& str)
{
	str = Libftpp::trimStartSpaces(str);
	str = Libftpp::trimEndSpaces(str);
	return (str);
}
...
std::string		Libftpp::replaceBySpace(std::string& str)
{
